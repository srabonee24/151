...
class User extends CI_Controller {
	...
	public function index()
	{
		...
		$data['user']=$this->db->get('tbl_famous_spots')->result_array();
	...
	public function add_user()
	{
		...
		$this->form_validation->set_rules('Spots_name', 'Spots Name', 'required');
		...
		public function edit_user($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data['user']=$this->db->where('s_id',$id)->get('tbl_famous_spots')->result_array();
			...
			$old_image=$this->db->where('s_id',$id)->get('tbl_famous_spots')->result_array();
